-- Schema + dati iniziali per SQLite (convertito da database.sql per MySQL).
...
CREATE TABLE IF NOT EXISTS users (
    ...
    max_distanza_km INTEGER DEFAULT NULL,
...
INSERT OR IGNORE INTO users (id, nome, cognome, eta, anni_esperienza, max_distanza_km, citta, lat, lon, email, password, ruolo, foto_profilo) VALUES 
