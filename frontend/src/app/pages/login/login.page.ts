...
export class LoginPage {
  ...
  // ---- Foto da fotocamera (Capacitor Camera) ----
  ...
  onFotoSelected(event: Event): void {
    ...
    // Ridimensiona/comprime la foto prima di inviarla, così il data URL resta
    // leggero e non supera il max_allowed_packet di MySQL al salvataggio.
  ...
  login(): void {
    this.api.login(this.loginEmail, this.loginPassword).subscribe({
      next: (data) => {
        this.auth.setToken(data.token); // salvo il JWT per le chiamate protette
